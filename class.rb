class Album
  attr_accessor :release_date, :artist, :title #gives you a getter and setter mthod "for free"
  ...
  def self.count #self keyword tells the program this is a class method 
    @@album_count 
  end 
